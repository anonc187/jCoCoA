 ...
 *
 */
public final class IntegerVariable extends AbstractPropertyOwner implements DiscreteVariable<Integer> {
     ...
     * (non-Javadoc)
     *
     * @see org.anon.cocoa.Variable#clear()
     */
    @Override
    public void clear() {
        this.set = false;
     ...
     * (non-Javadoc)
     *
     * @see org.anon.cocoa.DiscreteVariable#getLowerBound()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.anon.cocoa.DiscreteVariable#getUpperBound()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.anon.cocoa.Variable#getValue()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.anon.cocoa.Variable#isSet()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.anon.cocoa.DiscreteVariable#getIterator()
     */
    @Override
