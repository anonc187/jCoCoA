...
import org.anon.cocoa.solvers.UniqueFirstCooperativeSolver;
 ...
 */
@Deprecated
public class UniqueFirstCooperativeAgent extends LocalSolverAgent {
	 ...
	 * @param var
	 */
	public UniqueFirstCooperativeAgent(String name, Variable<?> var) {
		super(name, var);

		this.costfun = new LocalInequalityConstraintCostFunction(this);
		this.setSolver(new UniqueFirstCooperativeSolver(this, costfun), true);
	}
