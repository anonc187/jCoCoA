...
import org.anon.cocoa.solvers.GreedyLocalSolver;
...
public class SynchronousGreedyAgent extends LocalSolverAgent {
	 ...
	 * @param var
	 */
	public SynchronousGreedyAgent(String name, Variable<?> var) {
		super(name, var);

		this.costfun = new LocalInequalityConstraintCostFunction(this);
		this.setSolver(new GreedyLocalSolver(this, costfun), false);
	}
